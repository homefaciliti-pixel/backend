  ...
  Future<void> loadCategories() async {
    try {
      ...
      _categories = [
        ...
        CategoryModel(id: "ac_repair", title: "AcRepair", image: "https://raw.githubusercontent.com/homefaciliti-pixel/backend/main/backend/assets/categories/ac_repair.png"),
        ...
        CategoryModel(id: "bike_services", title: "Bike Services", image: "https://raw.githubusercontent.com/homefaciliti-pixel/backend/main/backend/assets/categories/bike_services.png"),
        CategoryModel(id: "architecture", title: "Architecture", image: "https://raw.githubusercontent.com/homefaciliti-pixel/backend/main/backend/assets/categories/architecture.jpg"),
        CategoryModel(id: "car_washing", title: "Car Washing", image: "https://raw.githubusercontent.com/homefaciliti-pixel/backend/main/backend/assets/categories/car_washing.png"),
        CategoryModel(id: "contractor", title: "Contractor", image: ""),
        CategoryModel(id: "mechanic", title: "Mechanic", image: "https://raw.githubusercontent.com/homefaciliti-pixel/backend/main/backend/assets/categories/mechanic.jpg"),
